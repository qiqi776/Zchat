...
type UserContact struct {
	...
	UserId      string    `gorm:"column:user_id;index;type:char(20);not null;comment:用户唯一id" json:"userId"`
	ContactId   string    `gorm:"column:contact_id;type:char(20);not null;comment:对应联系id" json:"contactId"`
	ContactType bool      `gorm:"column:contact_type;type:tinyint(1);not null;comment:联系类型，0.用户，1.群聊" json:"contactType"`
